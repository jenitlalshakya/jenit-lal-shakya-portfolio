        ...
        {projects.map((project) => (
          ...
          >
            <Image
              ...
              height={36}
              sizes="36px"
              className="mb-6 sm:mb-8 opacity-90 w-9 h-9 object-contain"
            />
            <h3 className="text-[1.2rem] font-medium sm:text-[1.375rem] text-(--on-surface)">
              {project.title}
            </h3>
            <p className="mt-5 text-sm leading-7 sm:mt-8 sm:text-base sm:leading-8 text-(--on-surface-variant)">
              {project.description}
            </p>
